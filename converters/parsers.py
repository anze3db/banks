...
class BankinterConfig:
    ...
    DESCRIPTION_MAPPINGS = {
        ...
        "Cobranca DD-20000136755 FIDELIDADE COMP": "Health",
        "Cobranca DD-05511019025 NOS Comunicacoe": "Household",
        "Cobranca DD-00159121887 AGUAS DE CASCAI": "Household",
        "Cobranca DD-00000252231 GALP POWER": "Household",
        "Cobranca DD-00000252231 PETROGAL": "Household",
        "FARMACIA": "Health",
    }
...
class N26Config:
    ...
    DESCRIPTION_MAPPINGS = {
        ...
        "LIDL": "Groceries",
        "MOJ.A1.SI": "Household",
        "PEIXARIA ESTORIL MAR": "Groceries",
        "PINGO DOCE": "Groceries",
        "GROUND BURGUER": "Restaurants",
        "OBRESTI": "Bank",
        "STR.EVID.PRILIVA": "Bank",
        "STROŠEK VODENJA": "Bank",
        "CONTINENTE": "Groceries",
        "INTERMARCHE ERICEIRA": "Car",
        "CELEIRO DA ALDEIA": "Groceries",
        "LUAR DA BARRA": "Restaurants",
        "POSTO ESTORIL V 3": "Car",
    }
